...
if __name__ == "__main__":
    ...
    argparser.add_argument('--related_work_file', type=str)
    ...
    if not args.intent: # determine intents for related work sections
        ...
        acc = sum(results)/len(results) # compute intent accuracy
