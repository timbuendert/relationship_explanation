...
class Seq2SeqDataCollator:
    ...
    def _encode(self, batch) -> Dict[str, torch.Tensor]:
        ...
        # new variant based on https://huggingface.co/transformers/v3.5.1/_modules/transformers/tokenization_bart.html
        self.dataset_kwargs.pop("src_lang", None)
        self.dataset_kwargs.pop("tgt_lang", None)
        ...
        return model_inputs #batch_encoding.data
...
def calculate_bert_scores(pred_lst, target_lst, verb=False):
    _, _, F1 = score(pred_lst, target_lst, lang="en-sci", verbose=verb, idf=True)
